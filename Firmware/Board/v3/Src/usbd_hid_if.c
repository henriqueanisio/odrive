...
__ALIGN_BEGIN uint8_t HID_ReportDesc[HID_REPORT_DESC_SIZE] __ALIGN_END = {
  ...
  /* Joystick Input Report - Alterado para ID 0x01 para melhor compatibilidade */
...
/* PID State Report - Mantenha o ID 02, mas garanta que a Usage Page 0x0F esteja ativa */
...
0xA1, 0x02,        /* Collection (Logical) */
  ...
  0xA1, 0x02, // COLLECTION (Logical)
	0x85, 0x10, // REPORT_ID (07) -- 7 avoids conflict with Output 0x05/0x06
	0x09, 0x25, // USAGE (Effect Type)
	0xA1, 0x02, // COLLECTION (Logical)
	  0x09, 0x26, // USAGE (26)
	  0x09, 0x27, // USAGE (27)
...
0xC0,              /* End Collection (TLC1 — Joystick Application)           */
  ...
  0xA1, 0x01,        /* Collection (Application)                              */
    ...
    0x85, 0x13,      /* Report ID (0x20) — Telemetry Input (52 bytes)         */
    0x09, 0x02,
    0x15, 0x00,
    0x26, 0xFF, 0x00,
    0x75, 0x08,
    ...
    0x85, 0x14,      /* Report ID (0x22) — Config Response Input (6 bytes)    */
    0x09, 0x04,
    0x15, 0x00,
    0x26, 0xFF, 0x00,
    0x75, 0x08,
    ...
    0x85, 0x15,      /* Report ID (0x21) — Command Feature (8 bytes)          */
    0x09, 0x03,
    0x15, 0x00,
    0x26, 0xFF, 0x00,
    0x75, 0x08,
