...
void safety_critical_arm_brake_resistor() {
    CRITICAL_SECTION() {
        ...
        /* TIM2 remapped to encoder — brake resistor PWM disabled */
    }
}
...
void start_adc_pwm() {
    ...
    // TIM2 remapped to encoder (PA0/PA1) — brake resistor PWM disabled
#if HW_VERSION_MAJOR == 3
    // (brake resistor PWM start removed)
#endif
